...
DC_RELAY_NETS="10.0.0.0/8;172.55.0.25/12;172.55.0.0/24;192.168.0.0/16;::1"
...
dc_other_hostnames='paperchase.test;$MAIN_LOCAL_DOMAINS'
dc_local_interfaces='$MAIN_LOCAL_INTERFACES'
dc_readhost=''
dc_relay_domains=''
dc_minimaldns='false'
